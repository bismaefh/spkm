...
<div class="col-12 grid-margin stretch-card">
    <div class="card  bg-gradient-primary">
        <div class="card-body">
            <h2 class="card-title text-white text-center mt-2">Ubah Data Mahasiswa</h2>
        </div>
    </div>
</div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form action="/datamahasiswa/rubah" method="post">
              {{ csrf_field() }}
      
            <div class="modal-body">
            <div class="form-group">
                <label for="exampleInputEmail1">NIM</label>
                <input type="text" name="nim" class="form-control" placeholder="Nama" required value="{{ $p->nim}}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" placeholder="Nama" required value="{{ $p->email}}">
              </div>
              <div class="form-group">
            ...
            <div class="modal-footer">
              <a href="/datamahasiswa/" class="btn btn-default" >Close</a>
